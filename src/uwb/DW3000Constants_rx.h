...
#ifndef _DW3000CONSTANTS_RX_H_
#define _DW3000CONSTANTS_RX_H_
...
#define SYS_STATUS_FRAME_RX_TIMEOUT 0x20000
#define SYS_STATUS_FRAME_RX_SUCC 0x2000
#define SYS_STATUS_RX_ERR 0x4259000

#define SYS_STATUS_FRAME_TX_SUCC 0x80

#define PREAMBLE_32 4
#define PREAMBLE_64 1
...
/* 12ms delay*/
#define TRANSMIT_DELAY_4MS_LESS1 0xE70F000
#define TRANSMIT_DELAY_4MS_LESS 0xE7EF000
#define TRANSMIT_DELAY_4MS 0xF424000 // //0x77359400
#define TRANSMIT_DELAY_12MS 0x2DC6C000 // //0x77359400
#define TRANSMIT_DELAY_12MS_MORE 0x29F65000
#define TRANSMIT_DELAY_16MS 0x3D090000 // //0x77359400
#define TRANSMIT_DELAY_36MS 0x89544000 // //0x77359400
#define TRANSMIT_DELAY_40MS 0x98968000 // //0x77359400
#define RECEIVE_DELAY  0xE7EF000 // //0x77359400

#define RECEIVE_DELAY_FINAL_16MS  0x487AB000 // //0x77359400
#define RECEIVE_DELAY_FINAL_12MS   0x57BCF000 // //0x77359400
#define RECEIVE_DELAY_FINAL_12MS_LESS   0x57B0F000 // //0x77359400
...
// LƯU Ý: bản gốc còn một dòng "#define SPEED_OF_LIGHT (299702547)" ở đây (m/s).
// Nó redefine hằng cm/ps phía trên -> mọi phép tính cm nhân sai hệ số ~1e10.
// Đã xoá; chỉ giữ SPEED_OF_LIGHT = 0.0299792458 cm/ps đúng với PS_UNIT.
